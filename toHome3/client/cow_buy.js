...
export function onClickBuyCow(event) {
  ...
  if (event.currentTarget.getAttribute("id") == "buy_miku_cow_art") {
    checkBuyingAbility(event, "buy_miku_cow_art", "miku cow", 39393, 39, 8);
  } else if (event.currentTarget.getAttribute("id") == "udder_cow_buy_art") {
    checkBuyingAbility(event, "udder_cow_buy_art", "udder cow", 150, 3, 2);
  } else if (
    ...
    checkBuyingAbility(event, "buy_pig_cow_art", "pig cow", 800, 15, 4);
    ...
    checkBuyingAbility(event, "buy_ice_cow_art", "ice cow", 1800, 50, 6);
    ...
    checkBuyingAbility(event, "buy_mustafa_cow_art", "hamster-cow", 10000, 200, 9)
  }
}
